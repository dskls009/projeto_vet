            ...
            <tr :props="props">
              <q-td :props="props" key="id"
                ><q-btn
                  ...
                  color="primary"
                  rounded
                  @click="$router.push(`/medicamento/edicao/${props.row.id}`)"
                />
                <q-btn
                  size="sm"
                  dense
              ...
              <q-td :props="props" key="unidade_medida">
                {{ props.row.unidade_medida }}
              </q-td>
              <q-td :props="props" key="bula">
                <q-btn
                  size="sm"
                  dense
                  icon="description"
                  flat
                  rounded
                  @click="baixar_bula(props.row.bula__id)"
                />
              </q-td>
...
import { findall, erase } from '../../services/veterinaria/MedicamentoService';
import { download } from './../../services/commons/Base64Service';

export default defineComponent({
  name: 'MedicamentoBuscaView',
  data() {
    return {
      filtro: undefined,
      pagination: {
