            ...
            <tr :props="props">
              <q-td :props="props" key="id"
                ><q-btn
                  ...
                  @click="
                    $router.push(
                      `/atendimento/edicao/${props.row.animal__id}/${props.row.id}`
                    )
                  "/>
                <q-btn
                  size="sm"
...
import { findall, erase } from '../../services/veterinaria/AtendimentoService';
...
export default defineComponent({
  ...
  methods: {
    ...
    registrar_medicamento: function(pk) {
      this.$router.push(`/medicamento_administrado/cadastro/atendimento/${pk}`);
    },
    buscar_medicamento: function(pk) {
      this.$router.push(`/medicamento_administrado/busca/atendimento/${pk}`);
    },
