            ...
            <tr :props="props">
              <q-td :props="props" key="id"
                ><q-btn
                  ...
                  color="primary"
                  rounded
                  @click="$router.push(`/doença/edicao/${props.row.id}`)"
                    />
                <q-btn
                  size="sm"
                  dense
              ...
              <q-td :props="props" key="doenca">
                {{ props.row.doenca }}
              </q-td>
              <q-td :props="props" key="cronica">
                {{ props.row.cronica ? 'Crônica' : '' }}
              </q-td>
...
import { findall, erase } from '../../services/veterinaria/DoencaService';
