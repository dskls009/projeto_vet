            ...
            <tr :props="props">
              <q-td :props="props" key="id"
                ><q-btn
                  ...
                  @click="
                    $router.push(
                      `/cirurgia/edicao/${props.row.animal__id}/${props.row.id}`
                    )
                  "/>
                <q-btn
                  size="sm"
...
import { findall, erase } from '../../services/veterinaria/CirurgiaService';
import { SessionStorage } from 'quasar';

export default defineComponent({
  name: 'CirurgiaBuscaView',
  data() {
    return {
      filtro: undefined,
      pagination: {
  ...
  methods: {
    ...
    registrar_medicamento: function(pk) {
      this.$router.push(`/medicamento_administrado/cadastro/cirurgia/${pk}`);
    },
    buscar_medicamento: function(pk) {
      this.$router.push(`/medicamento_administrado/busca/cirurgia/${pk}`);
    },
