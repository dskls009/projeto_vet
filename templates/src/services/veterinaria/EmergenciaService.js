...
export function findall(vue){
    vue.$axios({
        method: 'GET',
        headers: headers(),
        url: `${vue.$servidor()}/veterinaria/emergencia`,
        params: {
            filtro: vue.filtro,
            animal: vue.animal
        }
...
export function get(vue){
    vue.$axios({
        method: 'GET',
        headers: headers(),
        url: `${vue.$servidor()}/veterinaria/emergencia/${vue.pk}`,
    }).then(response =>{
...
export function save(vue){
    let url = '/veterinaria/emergencia/create'
    if (vue.form && vue.form.id){
        url = `/veterinaria/emergencia/${vue.form.id}/edit`
    }
    vue.$axios({
        method: 'POST',
        headers: headers(),
...
export function erase(vue){
    let url = `/veterinaria/emergencia/${vue.pk}/delete`
    vue.$axios({
        method: 'DELETE',
        headers: headers(),
        url: vue.$servidor() + url
