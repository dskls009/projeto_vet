...
export function findall(vue){
    vue.$axios({
        method: 'GET',
        headers: headers(),
        url: `${vue.$servidor()}/veterinaria/receituario`,
        params: {
            filtro: vue.filtro,
        }
    }).then(response =>{
...
export function get(vue){
    vue.$axios({
        method: 'GET',
        headers: headers(),
        url: `${vue.$servidor()}/veterinaria/receituario/${vue.pk}`,
    }).then(response =>{
...
export function save(vue){
    let url = '/veterinaria/receituario/create'
    if (vue.form && vue.form.id){
        url = `/veterinaria/receituario/${vue.form.id}/edit`
    }
    vue.$axios({
        method: 'POST',
        headers: headers(),
...
export function erase(vue){
    let url = `/veterinaria/receituario/${vue.pk}/delete`
    vue.$axios({
        method: 'DELETE',
        headers: headers(),
        url: vue.$servidor() + url
