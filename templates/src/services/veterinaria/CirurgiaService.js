...
export function findall(vue){
    vue.$axios({
        method: 'GET',
        headers: headers(),
        url: `${vue.$servidor()}/veterinaria/cirurgia`,
        params: {
            filtro: vue.filtro,
            animal: vue.animal
        }
...
export function get(vue){
    vue.$axios({
        method: 'GET',
        headers: headers(),
        url: `${vue.$servidor()}/veterinaria/cirurgia/${vue.pk}`,
    }).then(response =>{
...
export function save(vue){
    let url = '/veterinaria/cirurgia/create'
    if (vue.form && vue.form.id){
        url = `/veterinaria/cirurgia/${vue.form.id}/edit`
    }
    vue.$axios({
        method: 'POST',
        headers: headers(),
...
export function erase(vue){
    let url = `/veterinaria/cirurgia/${vue.pk}/delete`
    vue.$axios({
        method: 'DELETE',
        headers: headers(),
        url: vue.$servidor() + url
